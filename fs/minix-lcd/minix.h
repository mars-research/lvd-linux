...
#if defined(CONFIG_MINIX_FS_LCD_NATIVE_ENDIAN) && \
	defined(CONFIG_MINIX_FS__LCD_BIG_ENDIAN_16BIT_INDEXED)

#error Minix file system byte order broken

#elif defined(CONFIG_MINIX_FS_LCD_NATIVE_ENDIAN)
...
#elif defined(CONFIG_MINIX_FS_LCD_BIG_ENDIAN_16BIT_INDEXED)
