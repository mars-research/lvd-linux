...
#define SET_SYSCALL_ID(msg, id)		do {		\
		memset(msg, 0x0, sizeof(*msg));		\
		msg->syscall_nr = id;			\
	} while(0)

#define PREP_SYSCALL_MSG(msg)		do {		\
...
static inline void lvd_syscall_one_arg(struct fipc_message *m, int id, unsigned long arg0)
{
	SET_SYSCALL_ID(m, id);
	PREP_SYSCALL_MSG(m);
...
static inline void lvd_syscall_two_args(struct fipc_message *m, int id, 
				unsigned long arg0,
				unsigned long arg1)
{
	SET_SYSCALL_ID(m, id);
...
static inline void lvd_syscall_three_args(struct fipc_message *m, int id, 
					unsigned long arg0,
					unsigned long arg1,
					unsigned long arg2)
{
...
static inline void lvd_syscall_four_args(struct fipc_message *m, int id, 
					unsigned long arg0,
					unsigned long arg1,
					unsigned long arg2,
					unsigned long arg3)
...
static inline void lvd_syscall_five_args(struct fipc_message *m, int id, 
					unsigned long arg0,
					unsigned long arg1,
					unsigned long arg2,
					unsigned long arg3,
