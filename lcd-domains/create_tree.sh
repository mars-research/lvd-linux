...
create_files() {
    ...
    touch ${MODULE}/{cap.c,glue_helper.h} \
            ${MODULE}/boot/main.c \
            ${MODULE}/${LCD}/{main.c,${MODULE}_caller.h} \
            ${MODULE}/${LCD}/glue/{${MODULE}_caller,dispatch}.c \
            ${MODULE}/${KLCD}/{main.c,${MODULE}_callee.h} \
            ${MODULE}/${KLCD}/glue/{${MODULE}_callee,dispatch}.c \
...
klcd_kbuild() {
    ...
    echo -e "\t\t\t\t\t\tdispatch.o )" >> ${MODULE}/${KLCD}/Kbuild;
    echo -e "lcd_test_mod_${MODULE}_${LCD}-y\t\t+= \$(addprefix ../, cap.o" >> ${MODULE}/${KLCD}/Kbuild;
...
lcd_kbuild() {
    ...
    echo -e "\t\t\t\t\t\tdispatch.o )" >> ${MODULE}/${LCD}/Kbuild;
    echo -e "lcd_test_mod_${MODULE}_${LCD}-y\t\t+= \$(addprefix ../, cap.o" >> ${MODULE}/${LCD}/Kbuild;
