...
struct kmem_cache *
memcg_kmem_get_cache(struct kmem_cache *cachep)
{
        return cachep;
}
...
/* BEGIN LCD */
/* no external setup - these are set in kmem_cache_init */
#if 0
/* END LCD */
...
static struct notifier_block data cpucache_notifier = {
...
/* BEGIN LCD */
/* must be non static, we will call it */
#if 0
/* END LCD */
...
slab_out_of_memory(struct kmem_cache *cachep, gfp_t gfpflags, int nodeid)
{
	...
	struct page *page;
/* BEGIN LCD */
/* fix to get rid of compiler warning */
#if 0
/* END LCD */	
	unsigned long flags;
/* BEGIN LCD */
...
static bool slab_should_failslab(struct kmem_cache *cachep, gfp_t flags)
{
	...
	return should_failslab(cachep, flags);
}
