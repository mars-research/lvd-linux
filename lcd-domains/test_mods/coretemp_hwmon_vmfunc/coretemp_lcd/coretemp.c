...
#ifdef LCD_ISOLATE
static struct platform_driver_container coretemp_driver_container = {
	.platform_driver = {
#else
...
#endif
{
	...
	err = platform_driver_register(&coretemp_driver_container.platform_driver);
	if (err)
		goto exit;
...
#ifndef CONFIG_HOTPLUG_CPU
exit_driver_unreg:
	platform_driver_unregister(&coretemp_driver_container.platform_driver);
#endif
exit:
	return err;
}
