...
int trmp_impl_probe(fptr_probe target, struct pci_dev* pdev, struct pci_device_id* ent)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		if (*pdev_ptr) {
			caller_marshal_kernel__probe__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*ent_ptr) {
			caller_marshal_kernel__probe__ent__in(__pos, __msg, __ext, ctx, *ent_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_probe);

	*__pos = 0;
	{
		if (*pdev_ptr) {
			caller_unmarshal_kernel__probe__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}
	...
	{
		if (*ent_ptr) {
			caller_unmarshal_kernel__probe__ent__in(__pos, __msg, __ext, ctx, *ent_ptr);
		}
...
void trmp_impl_remove(fptr_remove target, struct pci_dev* pdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*pdev_ptr) {
			caller_marshal_kernel__remove__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_remove);

	*__pos = 0;
	{
		if (*pdev_ptr) {
			caller_unmarshal_kernel__remove__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}
...
void trmp_impl_shutdown(fptr_shutdown target, struct pci_dev* pdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*pdev_ptr) {
			caller_marshal_kernel__shutdown__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_shutdown);

	*__pos = 0;
	{
		if (*pdev_ptr) {
			caller_unmarshal_kernel__shutdown__pdev__in(__pos, __msg, __ext, ctx, *pdev_ptr);
		}
...
void trmp_impl_ndo_set_rx_mode(fptr_ndo_set_rx_mode target, struct net_device* netdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_set_rx_mode__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_set_rx_mode__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_stop(fptr_ndo_stop target, struct net_device* netdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_stop__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_ndo_stop);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_stop__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_open(fptr_ndo_open target, struct net_device* netdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_open__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_ndo_open);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_open__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_start_xmit(fptr_ndo_start_xmit target, struct sk_buff* skb, struct net_device* netdev)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		if (*skb_ptr) {
			caller_marshal_kernel__ndo_start_xmit__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...

	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_start_xmit__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
	...
	*__pos = 0;
	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			caller_unmarshal_kernel__ndo_start_xmit__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_start_xmit__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
unsigned long long trmp_impl_ndo_features_check(fptr_ndo_features_check target, struct sk_buff* skb, struct net_device* dev, unsigned long long features)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			caller_marshal_kernel__ndo_features_check__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			caller_marshal_kernel__ndo_features_check__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_ndo_features_check);

	*__pos = 0;
	{
		if (*skb_ptr) {
			caller_unmarshal_kernel__ndo_features_check__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	{
		if (*dev_ptr) {
			caller_unmarshal_kernel__ndo_features_check__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
int trmp_impl_ndo_set_mac_address(fptr_ndo_set_mac_address target, struct net_device* netdev, void* p)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_set_mac_address__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_set_mac_address__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_do_ioctl(fptr_ndo_do_ioctl target, struct net_device* netdev, struct ifreq* req, int cmd)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_do_ioctl__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*req_ptr) {
			caller_marshal_kernel__ndo_do_ioctl__req__in(__pos, __msg, __ext, ctx, *req_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_ndo_do_ioctl);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_do_ioctl__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
	...
	{
		if (*req_ptr) {
			caller_unmarshal_kernel__ndo_do_ioctl__req__in(__pos, __msg, __ext, ctx, *req_ptr);
		}
...
int trmp_impl_ndo_change_mtu(fptr_ndo_change_mtu target, struct net_device* netdev, int new_mtu)
{
	...
	{
		glue_pack(__pos, __msg, __ext, *new_mtu_ptr);
	}

	glue_call_client(__pos, __msg, RPC_ID_ndo_change_mtu);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_change_mtu__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
void trmp_impl_ndo_tx_timeout(fptr_ndo_tx_timeout target, struct net_device* netdev)
{
	...
	glue_call_client(__pos, __msg, RPC_ID_ndo_tx_timeout);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_tx_timeout__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
struct rtnl_link_stats64* trmp_impl_ndo_get_stats64(fptr_ndo_get_stats64 target, struct net_device* netdev, struct rtnl_link_stats64* stats)
{
	...
	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_get_stats64__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_setup_tc(fptr_ndo_setup_tc target, struct net_device* dev, unsigned int handle, unsigned short proto, struct tc_to_netdev* tc)
{
	...
	{
		glue_pack(__pos, __msg, __ext, *handle_ptr);
	}

	{
		glue_pack(__pos, __msg, __ext, *proto_ptr);
	}

	{
		__maybe_unused const void* __adjusted = *tc_ptr;
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*tc_ptr) {
			caller_marshal_kernel__ndo_setup_tc__tc__in(__pos, __msg, __ext, ctx, *tc_ptr);
		}

	}

	glue_call_client(__pos, __msg, RPC_ID_ndo_setup_tc);
	...
	*__pos = 0;
	...
	{
		if (*tc_ptr) {
			caller_unmarshal_kernel__ndo_setup_tc__tc__in(__pos, __msg, __ext, ctx, *tc_ptr);
		}
...
unsigned long long trmp_impl_ndo_fix_features(fptr_ndo_fix_features target, struct net_device* netdev, unsigned long long features)
{
	...
	glue_call_client(__pos, __msg, RPC_ID_ndo_fix_features);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_fix_features__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_set_features(fptr_ndo_set_features target, struct net_device* netdev, unsigned long long features)
{
	...
	glue_call_client(__pos, __msg, RPC_ID_ndo_set_features);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_set_features__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
int trmp_impl_ndo_set_tx_maxrate(fptr_ndo_set_tx_maxrate target, struct net_device* netdev, int queue_index, unsigned int maxrate)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*netdev_ptr) {
			caller_marshal_kernel__ndo_set_tx_maxrate__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
	...
	{
		glue_pack(__pos, __msg, __ext, *maxrate_ptr);
	}

	glue_call_client(__pos, __msg, RPC_ID_ndo_set_tx_maxrate);

	*__pos = 0;
	{
		if (*netdev_ptr) {
			caller_unmarshal_kernel__ndo_set_tx_maxrate__netdev__in(__pos, __msg, __ext, ctx, *netdev_ptr);
		}
...
void lvd_setup_timer_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	...
	__maybe_unused struct lvd_setup_timer_call_ctx call_ctx = {timer, func, flags};
	...
	lvd_setup_timer(timer, func, flags);
...
void pci_bus_read_config_word_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*bus_ptr = glue_unpack(__pos, __msg, __ext, struct pci_bus*);
		if (*bus_ptr) {
			callee_unmarshal_kernel__pci_bus_read_config_word__bus__in(__pos, __msg, __ext, ctx, *bus_ptr);
		}
	...
	{
		*pos_ptr = glue_unpack(__pos, __msg, __ext, int);
	}

	{
		size_t __size = sizeof(unsigned short);
		*value_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, unsigned short*, (__size), (DEFAULT_GFP_FLAGS));
		(void)value_ptr;
	}
	...
	*__pos = 0;
	{
		if (*bus_ptr) {
			callee_marshal_kernel__pci_bus_read_config_word__bus__in(__pos, __msg, __ext, ctx, *bus_ptr);
		}
...
void pci_bus_write_config_word_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*bus_ptr = glue_unpack(__pos, __msg, __ext, struct pci_bus*);
		if (*bus_ptr) {
			callee_unmarshal_kernel__pci_bus_write_config_word__bus__in(__pos, __msg, __ext, ctx, *bus_ptr);
		}
	...
	*__pos = 0;
	{
		if (*bus_ptr) {
			callee_marshal_kernel__pci_bus_write_config_word__bus__in(__pos, __msg, __ext, ctx, *bus_ptr);
		}
...
void pci_dev_put_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct pci_dev*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__pci_dev_put__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__pci_dev_put__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void queue_work_on_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*wq_ptr = glue_unpack(__pos, __msg, __ext, struct workqueue_struct*);
		if (*wq_ptr) {
			callee_unmarshal_kernel__queue_work_on__wq__in(__pos, __msg, __ext, ctx, *wq_ptr);
		}
...

	{
		*work_ptr = glue_unpack(__pos, __msg, __ext, struct work_struct*);
		if (*work_ptr) {
			callee_unmarshal_kernel__queue_work_on__work__in(__pos, __msg, __ext, ctx, *work_ptr);
		}
	...
	*__pos = 0;
	...
	{
		if (*wq_ptr) {
			callee_marshal_kernel__queue_work_on__wq__in(__pos, __msg, __ext, ctx, *wq_ptr);
		}
	...
	{
		if (*work_ptr) {
			callee_marshal_kernel__queue_work_on__work__in(__pos, __msg, __ext, ctx, *work_ptr);
		}
...
void pcie_get_minimum_link_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct pci_dev*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__pcie_get_minimum_link__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...

	{
		...
		*speed_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, unsigned int*, (__size), (DEFAULT_GFP_FLAGS));
		if (*speed_ptr) {
	...
	{
		size_t __size = sizeof(unsigned int);
		*width_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, unsigned int*, (__size), (DEFAULT_GFP_FLAGS));
		if (*width_ptr) {
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__pcie_get_minimum_link__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void pcie_capability_read_word_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct pci_dev*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__pcie_capability_read_word__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__pcie_capability_read_word__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void pci_wake_from_d3_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct pci_dev*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__pci_wake_from_d3__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__pci_wake_from_d3__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void msleep_interruptible_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*msecs_ptr = glue_unpack(__pos, __msg, __ext, unsigned int);
	}
...
void netdev_rss_key_fill_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*len_ptr = glue_unpack(__pos, __msg, __ext, unsigned long);
	}
	...
	*__pos = 0;
	{
		__maybe_unused const void* __adjusted = *buffer_ptr;
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*buffer_ptr) {
		}
...
void rtnl_is_locked_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...
void skb_copy_bits_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff const*);
		if (*skb_ptr) {
			...
			callee_unmarshal_kernel__skb_copy_bits__skb__io(__pos, __msg, __ext, ctx, writable);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__skb_copy_bits__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void ___pskb_trim_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel_____pskb_trim__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel_____pskb_trim__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void pskb_expand_head_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__pskb_expand_head__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}

	}

	{
		*nhead_ptr = glue_unpack(__pos, __msg, __ext, int);
	}

	{
		*ntail_ptr = glue_unpack(__pos, __msg, __ext, int);
	}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__pskb_expand_head__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void __pskb_pull_tail_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel____pskb_pull_tail__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}

	}

	{
		*delta_ptr = glue_unpack(__pos, __msg, __ext, int);
	}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel____pskb_pull_tail__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void skb_tstamp_tx_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*orig_skb_ptr = glue_unpack(__pos, __msg, __ext, struct sk_buff*);
		if (*orig_skb_ptr) {
			callee_unmarshal_kernel__skb_tstamp_tx__orig_skb__io(__pos, __msg, __ext, ctx, *orig_skb_ptr);
		}

	}

	{
		*hwtstamps_ptr = glue_unpack(__pos, __msg, __ext, struct skb_shared_hwtstamps*);
		if (*hwtstamps_ptr) {
			callee_unmarshal_kernel__skb_tstamp_tx__hwtstamps__in(__pos, __msg, __ext, ctx, *hwtstamps_ptr);
		}
	...
	*__pos = 0;
	{
		if (*orig_skb_ptr) {
			callee_marshal_kernel__skb_tstamp_tx__orig_skb__io(__pos, __msg, __ext, ctx, *orig_skb_ptr);
		}
	...
	{
		if (*hwtstamps_ptr) {
			callee_marshal_kernel__skb_tstamp_tx__hwtstamps__in(__pos, __msg, __ext, ctx, *hwtstamps_ptr);
		}
...
void skb_pad_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__skb_pad__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}

	}

	{
		*pad_ptr = glue_unpack(__pos, __msg, __ext, int);
	}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__skb_pad__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void napi_consume_skb_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__napi_consume_skb__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	*__pos = 0;
	{
		if (*skb_ptr) {
			callee_marshal_kernel__napi_consume_skb__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void __dev_kfree_skb_any_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel____dev_kfree_skb_any__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}

	}

	{
		*reason_ptr = glue_unpack(__pos, __msg, __ext, unsigned int);
	}
	...
	*__pos = 0;
	{
		if (*skb_ptr) {
			callee_marshal_kernel____dev_kfree_skb_any__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void __napi_alloc_skb_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel____napi_alloc_skb__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
	...
	*__pos = 0;
	{
		if (*napi_ptr) {
			callee_marshal_kernel____napi_alloc_skb__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
	...
	{
		if (*ret_ptr) {
			callee_marshal_kernel____napi_alloc_skb__ret_sk_buff__in(__pos, __msg, __ext, ctx, *ret_ptr);
		}
...
void napi_gro_flush_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__napi_gro_flush__napi__io(__pos, __msg, __ext, ctx, *napi_ptr);
		}

	}

	{
		*flush_old_ptr = glue_unpack(__pos, __msg, __ext, bool);
	}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*napi_ptr) {
			callee_marshal_kernel__napi_gro_flush__napi__io(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void napi_complete_done_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*work_done_ptr = glue_unpack(__pos, __msg, __ext, int);
	}
...
void call_netdevice_notifiers_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*val_ptr = glue_unpack(__pos, __msg, __ext, unsigned long);
	}

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__call_netdevice_notifiers__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	...
	{
		if (*dev_ptr) {
			callee_marshal_kernel__call_netdevice_notifiers__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void dev_get_stats_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__dev_get_stats__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...

	{
		...
		*storage_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct rtnl_link_stats64*, (__size), (DEFAULT_GFP_FLAGS));
		if (*storage_ptr) {
			callee_unmarshal_kernel__dev_get_stats__storage__in(__pos, __msg, __ext, ctx, *storage_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__dev_get_stats__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	{
		if (*storage_ptr) {
			callee_marshal_kernel__dev_get_stats__storage__in(__pos, __msg, __ext, ctx, *storage_ptr);
		}
...

	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*ret_ptr) {
			callee_marshal_kernel__dev_get_stats__ret_rtnl_link_stats64__out(__pos, __msg, __ext, ctx, *ret_ptr);
		}
...
void unregister_netdev_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__unregister_netdev__dev__io(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			callee_marshal_kernel__unregister_netdev__dev__io(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_napi_del_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__netif_napi_del__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
	...
	*__pos = 0;
	{
		if (*napi_ptr) {
			callee_marshal_kernel__netif_napi_del__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void napi_hash_del_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__napi_hash_del__napi__io(__pos, __msg, __ext, ctx, *napi_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*napi_ptr) {
			callee_marshal_kernel__napi_hash_del__napi__io(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void register_netdev_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__register_netdev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__register_netdev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_tx_stop_all_queues_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_tx_stop_all_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_tx_stop_all_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_carrier_on_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
...

	{
		*dev_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_carrier_on__dev__io(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			callee_marshal_kernel__netif_carrier_on__dev__io(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netdev_all_upper_get_next_dev_rcu_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netdev_all_upper_get_next_dev_rcu__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*iter_ptr = glue_unpack(__pos, __msg, __ext, struct list_head**);
		if (*iter_ptr) {
			**iter_ptr = glue_unpack(__pos, __msg, __ext, struct list_head*);
			if (**iter_ptr) {
				callee_unmarshal_kernel__netdev_all_upper_get_next_dev_rcu__iter__in(__pos, __msg, __ext, ctx, **iter_ptr);
			}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netdev_all_upper_get_next_dev_rcu__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...

	{
		if (*iter_ptr) {
			if (**iter_ptr) {
				callee_marshal_kernel__netdev_all_upper_get_next_dev_rcu__iter__in(__pos, __msg, __ext, ctx, **iter_ptr);
			}
	...
	{
		if (*ret_ptr) {
			callee_marshal_kernel__netdev_all_upper_get_next_dev_rcu__ret_net_device__in(__pos, __msg, __ext, ctx, *ret_ptr);
		}
...
void napi_disable_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*n_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*n_ptr) {
			callee_unmarshal_kernel__napi_disable__n__in(__pos, __msg, __ext, ctx, *n_ptr);
		}
	...
	*__pos = 0;
	{
		if (*n_ptr) {
			callee_marshal_kernel__napi_disable__n__in(__pos, __msg, __ext, ctx, *n_ptr);
		}
...
int trmp_impl_poll(fptr_poll target, struct napi_struct* napi, int budget)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*napi_ptr) {
			caller_marshal_kernel__poll__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_poll);

	*__pos = 0;
	{
		if (*napi_ptr) {
			caller_unmarshal_kernel__poll__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void netif_napi_add_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_napi_add__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...

	{
		...
		*napi_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct napi_struct*, (__size), (DEFAULT_GFP_FLAGS));
		if (*napi_ptr) {
			callee_unmarshal_kernel__netif_napi_add__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}

	}

	{
		*poll_ptr = glue_unpack_rpc_ptr(__pos, __msg, __ext, poll);
	}

	{
		*weight_ptr = glue_unpack(__pos, __msg, __ext, int);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_napi_add__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	{
		if (*napi_ptr) {
			callee_marshal_kernel__netif_napi_add__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void __napi_schedule_irqoff_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*n_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*n_ptr) {
			callee_unmarshal_kernel____napi_schedule_irqoff__n__in(__pos, __msg, __ext, ctx, *n_ptr);
		}
	...
	*__pos = 0;
	{
		if (*n_ptr) {
			callee_marshal_kernel____napi_schedule_irqoff__n__in(__pos, __msg, __ext, ctx, *n_ptr);
		}
...
void napi_gro_receive_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__napi_gro_receive__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__napi_gro_receive__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	*__pos = 0;
	{
		if (*napi_ptr) {
			callee_marshal_kernel__napi_gro_receive__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...

	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__napi_gro_receive__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void netif_receive_skb_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__netif_receive_skb__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__netif_receive_skb__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void skb_checksum_help_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*skb_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct sk_buff*);
		if (*skb_ptr) {
			callee_unmarshal_kernel__skb_checksum_help__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
	...
	*__pos = 0;
	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*skb_ptr) {
			callee_marshal_kernel__skb_checksum_help__skb__io(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
void netif_device_attach_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_device_attach__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_device_attach__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_tx_wake_queue_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*dev_queue_ptr = glue_unpack(__pos, __msg, __ext, struct netdev_queue*);
		if (*dev_queue_ptr) {
			callee_unmarshal_kernel__netif_tx_wake_queue__dev_queue__in(__pos, __msg, __ext, ctx, *dev_queue_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_queue_ptr) {
			callee_marshal_kernel__netif_tx_wake_queue__dev_queue__in(__pos, __msg, __ext, ctx, *dev_queue_ptr);
		}
...
void netif_device_detach_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_device_detach__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_device_detach__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_wake_subqueue_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_wake_subqueue__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*queue_index_ptr = glue_unpack(__pos, __msg, __ext, unsigned short);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_wake_subqueue__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_set_real_num_rx_queues_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_set_real_num_rx_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*rxq_ptr = glue_unpack(__pos, __msg, __ext, unsigned int);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_set_real_num_rx_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_set_real_num_tx_queues_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_set_real_num_tx_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*txq_ptr = glue_unpack(__pos, __msg, __ext, unsigned int);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_set_real_num_tx_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void netif_set_xps_queue_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__netif_set_xps_queue__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...

	{
		...
		*mask_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct cpumask const*, (__size), (DEFAULT_GFP_FLAGS));
		if (*mask_ptr) {
			struct cpumask* writable = (struct cpumask*)*mask_ptr;
			callee_unmarshal_kernel__netif_set_xps_queue__mask__in(__pos, __msg, __ext, ctx, writable);
		}

	}

	{
		*index_ptr = glue_unpack(__pos, __msg, __ext, unsigned short);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__netif_set_xps_queue__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	{
		if (*mask_ptr) {
			callee_marshal_kernel__netif_set_xps_queue__mask__in(__pos, __msg, __ext, ctx, *mask_ptr);
		}
...
void synchronize_irq_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...
void dev_addr_del_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__dev_addr_del__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*addr_ptr = glue_unpack_shadow(__pos, __msg, __ext, unsigned char const*);
		if (*addr_ptr) {
	...
	{
		*addr_type_ptr = glue_unpack(__pos, __msg, __ext, unsigned char);
	}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__dev_addr_del__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void dev_addr_add_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__dev_addr_add__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__dev_addr_add__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
int trmp_impl_sync(fptr_sync target, struct net_device* dev, unsigned char const* addr)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			caller_marshal_kernel__sync__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_sync);

	*__pos = 0;
	{
		if (*dev_ptr) {
			caller_unmarshal_kernel__sync__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
int trmp_impl_unsync(fptr_unsync target, struct net_device* dev, unsigned char const* addr)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			caller_marshal_kernel__unsync__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_unsync);

	*__pos = 0;
	{
		if (*dev_ptr) {
			caller_unmarshal_kernel__unsync__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void __hw_addr_unsync_dev_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*list_ptr = glue_unpack(__pos, __msg, __ext, struct netdev_hw_addr_list*);
		if (*list_ptr) {
			callee_unmarshal_kernel____hw_addr_unsync_dev__list__in(__pos, __msg, __ext, ctx, *list_ptr);
		}
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel____hw_addr_unsync_dev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*unsync_ptr = glue_unpack_rpc_ptr(__pos, __msg, __ext, unsync);
	}
	...
	*__pos = 0;
	{
		if (*list_ptr) {
			callee_marshal_kernel____hw_addr_unsync_dev__list__in(__pos, __msg, __ext, ctx, *list_ptr);
		}
	...
	{
		if (*dev_ptr) {
			callee_marshal_kernel____hw_addr_unsync_dev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void __hw_addr_sync_dev_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		struct net_device* __net_device = glue_unpack(__pos, __msg, __ext, struct net_device*);
		*list_ptr = &__net_device->uc;
		if (*list_ptr) {
			callee_unmarshal_kernel____hw_addr_sync_dev__list__in(__pos, __msg, __ext, ctx, *list_ptr);
		}
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel____hw_addr_sync_dev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		*sync_ptr = glue_unpack_rpc_ptr(__pos, __msg, __ext, sync);
	}
	...
	*__pos = 0;
	{
		if (*list_ptr) {
			callee_marshal_kernel____hw_addr_sync_dev__list__in(__pos, __msg, __ext, ctx, *list_ptr);
		}
	...
	{
		if (*dev_ptr) {
			callee_marshal_kernel____hw_addr_sync_dev__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void eth_platform_get_mac_address_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		...
		*dev_ptr = &__pci_dev->dev;
		if (*dev_ptr) {
			callee_unmarshal_kernel__eth_platform_get_mac_address__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__eth_platform_get_mac_address__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void alloc_etherdev_mqs_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	*__pos = 0;
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*ret_ptr) {
			callee_marshal_kernel__alloc_etherdev_mqs__ret_net_device__out(__pos, __msg, __ext, ctx, *ret_ptr);
		}
...
void dev_trans_start_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__dev_trans_start__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__dev_trans_start__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
int trmp_impl_mdio_read(fptr_mdio_read target, struct net_device* dev, int prtad, int devad, unsigned short addr)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			caller_marshal_kernel__mdio_read__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	{
		glue_pack(__pos, __msg, __ext, *devad_ptr);
	}

	{
		glue_pack(__pos, __msg, __ext, *addr_ptr);
	}

	glue_call_client(__pos, __msg, RPC_ID_mdio_read);

	*__pos = 0;
	{
		if (*dev_ptr) {
			caller_unmarshal_kernel__mdio_read__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
int trmp_impl_mdio_write(fptr_mdio_write target, struct net_device* dev, int prtad, int devad, unsigned short addr, unsigned short val)
{
	...
	glue_pack(__pos, __msg, __ext, target);
	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*dev_ptr) {
			caller_marshal_kernel__mdio_write__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	glue_call_client(__pos, __msg, RPC_ID_mdio_write);

	*__pos = 0;
	{
		if (*dev_ptr) {
			caller_unmarshal_kernel__mdio_write__net_device__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void mdio_mii_ioctl_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	{
		*mdio_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct mdio_if_info const*);
		if (*mdio_ptr) {
			struct mdio_if_info* writable = (struct mdio_if_info*)*mdio_ptr;
			callee_unmarshal_kernel__mdio_mii_ioctl__mdio__in(__pos, __msg, __ext, ctx, writable);
		}
...

	{
		*mii_data_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct mii_ioctl_data*);
		if (*mii_data_ptr) {
			callee_unmarshal_kernel__mdio_mii_ioctl__mii_data__io(__pos, __msg, __ext, ctx, *mii_data_ptr);
		}
	...
	*__pos = 0;
	{
		if (*mdio_ptr) {
			callee_marshal_kernel__mdio_mii_ioctl__mdio__in(__pos, __msg, __ext, ctx, *mdio_ptr);
		}
...

	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*mii_data_ptr) {
			callee_marshal_kernel__mdio_mii_ioctl__mii_data__io(__pos, __msg, __ext, ctx, *mii_data_ptr);
		}
...
void mdio45_probe_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		...
		*mdio_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct mdio_if_info*, (__size), (DEFAULT_GFP_FLAGS));
		if (*mdio_ptr) {
			callee_unmarshal_kernel__mdio45_probe__mdio__in(__pos, __msg, __ext, ctx, *mdio_ptr);
		}
	...
	*__pos = 0;
	{
		if (*mdio_ptr) {
			callee_marshal_kernel__mdio45_probe__mdio__in(__pos, __msg, __ext, ctx, *mdio_ptr);
		}
...
void __pci_register_driver_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
...

	{
		...
		*drv_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct pci_driver*, (__size), (DEFAULT_GFP_FLAGS));
		if (*drv_ptr) {
			callee_unmarshal_kernel____pci_register_driver__drv__in(__pos, __msg, __ext, ctx, *drv_ptr);
		}
	...
	ret = __pci_register_driver(drv, THIS_MODULE, "ixgbe_gen");

	*__pos = 0;
	{
		if (*drv_ptr) {
			callee_marshal_kernel____pci_register_driver__drv__in(__pos, __msg, __ext, ctx, *drv_ptr);
		}
...
void lvd_napi_enable_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*napi_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__lvd_napi_enable__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}

	}

	lvd_napi_enable(napi);

	*__pos = 0;
	{
		if (*napi_ptr) {
			callee_marshal_kernel__lvd_napi_enable__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void lvd_netif_trans_update_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__lvd_netif_trans_update__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	lvd_netif_trans_update(dev);

	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__lvd_netif_trans_update__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void lvd_netif_tx_disable_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__lvd_netif_tx_disable__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	lvd_netif_tx_disable(dev);

	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__lvd_netif_tx_disable__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void lvd_napi_schedule_irqoff_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	__maybe_unused struct lvd_napi_schedule_irqoff_call_ctx call_ctx = {napi};
	__maybe_unused struct lvd_napi_schedule_irqoff_call_ctx *ctx = &call_ctx;
...

	{
		*napi_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct napi_struct*);
		if (*napi_ptr) {
			callee_unmarshal_kernel__lvd_napi_schedule_irqoff__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}

	}

	lvd_napi_schedule_irqoff(napi);

	*__pos = 0;
	{
		if (*napi_ptr) {
			callee_marshal_kernel__lvd_napi_schedule_irqoff__napi__in(__pos, __msg, __ext, ctx, *napi_ptr);
		}
...
void lvd_netif_tx_wake_all_queues_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__lvd_netif_tx_wake_all_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	lvd_netif_tx_wake_all_queues(dev);

	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__lvd_netif_tx_wake_all_queues__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void get_loops_per_jiffy_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...
void ethtool_op_get_link_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
...

	{
		*dev_ptr = glue_unpack(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__ethtool_op_get_link__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__ethtool_op_get_link__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
...
void ethtool_op_get_ts_info_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	__maybe_unused struct ethtool_op_get_ts_info_call_ctx call_ctx = {dev, info};
	__maybe_unused struct ethtool_op_get_ts_info_call_ctx *ctx = &call_ctx;
...

	{
		*dev_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct net_device*);
		if (*dev_ptr) {
			callee_unmarshal_kernel__ethtool_op_get_ts_info__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}

	}

	{
		size_t __size = sizeof(struct ethtool_ts_info);
		*info_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct ethtool_ts_info*, (__size), (DEFAULT_GFP_FLAGS));
		if (*info_ptr) {
			callee_unmarshal_kernel__ethtool_op_get_ts_info__info__in(__pos, __msg, __ext, ctx, *info_ptr);
		}
	...
	*__pos = 0;
	{
		if (*dev_ptr) {
			callee_marshal_kernel__ethtool_op_get_ts_info__dev__in(__pos, __msg, __ext, ctx, *dev_ptr);
		}
	...
	{
		if (*info_ptr) {
			callee_marshal_kernel__ethtool_op_get_ts_info__info__in(__pos, __msg, __ext, ctx, *info_ptr);
		}
...
void ipv6_find_hdr_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;
	...
	__maybe_unused struct ipv6_find_hdr_call_ctx call_ctx = {skb, offset, target, fragoff, flags};
	__maybe_unused struct ipv6_find_hdr_call_ctx *ctx = &call_ctx;
	...
	{
		*skb_ptr = glue_unpack(__pos, __msg, __ext, struct sk_buff const*);
		if (*skb_ptr) {
			struct sk_buff* writable = (struct sk_buff*)*skb_ptr;
			callee_unmarshal_kernel__ipv6_find_hdr__skb__in(__pos, __msg, __ext, ctx, writable);
		}
	...
	{
		size_t __size = sizeof(unsigned int);
		*offset_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, unsigned int*, (__size), (DEFAULT_GFP_FLAGS));
		(void)offset_ptr;
	}

	{
		*target_ptr = glue_unpack(__pos, __msg, __ext, int);
	}

	ret = ipv6_find_hdr(skb, offset, target, fragoff, flags);

	*__pos = 0;
	{
		if (*skb_ptr) {
			callee_marshal_kernel__ipv6_find_hdr__skb__in(__pos, __msg, __ext, ctx, *skb_ptr);
		}
...
int try_dispatch(enum RPC_ID id, struct fipc_message* __msg, struct ext_registers* __ext)
{
	...
	case RPC_ID_pcie_get_minimum_link:
		...
		pcie_get_minimum_link_callee(__msg, __ext);
		break;

	case RPC_ID_pcie_capability_read_word:
		glue_user_trace("pcie_capability_read_word\n");
		pcie_capability_read_word_callee(__msg, __ext);
		break;
	...
	case RPC_ID_pci_wake_from_d3:
		...
		pci_wake_from_d3_callee(__msg, __ext);
		break;
	...
	case RPC_ID___pskb_pull_tail:
		...
		__pskb_pull_tail_callee(__msg, __ext);
		break;
	...
	case RPC_ID_synchronize_irq:
		...
		synchronize_irq_callee(__msg, __ext);
		break;
	...
	case RPC_ID_lvd_napi_enable:
		...
		lvd_napi_enable_callee(__msg, __ext);
		break;

	case RPC_ID_lvd_netif_trans_update:
		glue_user_trace("lvd_netif_trans_update\n");
		lvd_netif_trans_update_callee(__msg, __ext);
		break;

	case RPC_ID_lvd_netif_tx_disable:
		glue_user_trace("lvd_netif_tx_disable\n");
		lvd_netif_tx_disable_callee(__msg, __ext);
		break;

	case RPC_ID_lvd_napi_schedule_irqoff:
		glue_user_trace("lvd_napi_schedule_irqoff\n");
		lvd_napi_schedule_irqoff_callee(__msg, __ext);
		break;

	case RPC_ID_lvd_netif_tx_wake_all_queues:
		glue_user_trace("lvd_netif_tx_wake_all_queues\n");
		lvd_netif_tx_wake_all_queues_callee(__msg, __ext);
		break;
	...
	case RPC_ID_ethtool_op_get_link:
		...
		ethtool_op_get_link_callee(__msg, __ext);
		break;

	case RPC_ID_ethtool_op_get_ts_info:
		glue_user_trace("ethtool_op_get_ts_info\n");
		ethtool_op_get_ts_info_callee(__msg, __ext);
		break;

	case RPC_ID_ipv6_find_hdr:
		glue_user_trace("ipv6_find_hdr\n");
		ipv6_find_hdr_callee(__msg, __ext);
		break;
