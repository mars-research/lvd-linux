 ...
 */
#ifdef LCD_ISOLATE
static struct pci_driver_container mei_me_driver_container = {
	.pci_driver = {
#else
...
{
	return pci_register_driver(&mei_me_driver_container.pci_driver);
}

void mei_me_exit(void)
{
	pci_unregister_driver(&mei_me_driver_container.pci_driver);
}
#endif
