...
struct class* __class_create(struct module* owner, char const* name, struct lock_class_key* key)
{
	...
	__maybe_unused const struct __class_create_call_ctx call_ctx = {owner, name, key};
...

	{
		...
		if (*owner_ptr) {
			caller_marshal_kernel____class_create__module__in(__pos, __msg, __ext, ctx, *owner_ptr);
		}
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*key_ptr) {
			caller_marshal_kernel____class_create__lock_class_key__in(__pos, __msg, __ext, ctx, *key_ptr);
		}
	...
	*__pos = 0;
	{
		if (*owner_ptr) {
			caller_unmarshal_kernel____class_create__module__in(__pos, __msg, __ext, ctx, *owner_ptr);
		}
	...
	{
		if (*key_ptr) {
			caller_unmarshal_kernel____class_create__lock_class_key__in(__pos, __msg, __ext, ctx, *key_ptr);
		}
...
int __register_chrdev(unsigned int major, unsigned int baseminor, unsigned int count, char const* name, struct file_operations const* fops)
{
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*fops_ptr) {
			caller_marshal_kernel___global_file_operations__in(__pos, __msg, __ext, *fops_ptr);
		}
	...
	*__pos = 0;
...

	{
		if (*fops_ptr) {
			...
			caller_unmarshal_kernel___global_file_operations__in(__pos, __msg, __ext, writable);
		}
...
void class_destroy(struct class* cls)
{
...

	{
		...
		if (*cls_ptr) {
			caller_marshal_kernel__class_destroy__class__in(__pos, __msg, __ext, ctx, *cls_ptr);
		}
	...
	*__pos = 0;
	{
		if (*cls_ptr) {
			caller_unmarshal_kernel__class_destroy__class__in(__pos, __msg, __ext, ctx, *cls_ptr);
		}
...
struct device* __device_create(struct class* class, struct device* parent, unsigned int devt, void* drvdata, char const* fmt, unsigned int cpu)
{
	...
	__maybe_unused const struct device_create_call_ctx call_ctx = {class, parent, devt, drvdata, fmt, cpu};
	__maybe_unused const struct device_create_call_ctx *ctx = &call_ctx;
...

	{
		...
		glue_pack_shadow(__pos, __msg, __ext, __adjusted);
		if (*class_ptr) {
			caller_marshal_kernel__device_create__class__in(__pos, __msg, __ext, ctx, *class_ptr);
		}
...

	{
		...
		glue_pack(__pos, __msg, __ext, __adjusted);
		if (*parent_ptr) {
			caller_marshal_kernel__device_create__device__in(__pos, __msg, __ext, ctx, *parent_ptr);
		}
	...
	glue_call_server(__pos, __msg, RPC_ID_device_create);

	*__pos = 0;
	{
		if (*class_ptr) {
			caller_unmarshal_kernel__device_create__class__in(__pos, __msg, __ext, ctx, *class_ptr);
		}
	...
	{
		if (*parent_ptr) {
			caller_unmarshal_kernel__device_create__device__in(__pos, __msg, __ext, ctx, *parent_ptr);
		}
...

	{
		*ret_ptr = glue_unpack_shadow(__pos, __msg, __ext, struct device*);
		if (*ret_ptr) {
			caller_unmarshal_kernel__device_create__ret_device__out(__pos, __msg, __ext, ctx, *ret_ptr);
		}
...
void llseek_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;

	fptr_llseek function_ptr = glue_unpack(__pos, __msg, __ext, fptr_llseek);
	struct file* file = 0;
	long long offset = 0;
	int whence = 0;
	struct file** file_ptr = &file;
	...
	__maybe_unused struct llseek_call_ctx call_ctx = {file, offset, whence};
	__maybe_unused struct llseek_call_ctx *ctx = &call_ctx;
...

	{
		...
		*file_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct file*, (__size), (DEFAULT_GFP_FLAGS));
		if (*file_ptr) {
			callee_unmarshal_kernel__llseek__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
	...
	ret = function_ptr(file, offset, whence);

	*__pos = 0;
	{
		if (*file_ptr) {
			callee_marshal_kernel__llseek__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
...
void msr_read_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;

	fptr_msr_read function_ptr = glue_unpack(__pos, __msg, __ext, fptr_msr_read);
	struct file* file = 0;
	char* buf = 0;
	...
	__maybe_unused struct msr_read_call_ctx call_ctx = {file, buf, count, ppos};
	__maybe_unused struct msr_read_call_ctx *ctx = &call_ctx;
...

	{
		...
		*file_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct file*, (__size), (DEFAULT_GFP_FLAGS));
		if (*file_ptr) {
			callee_unmarshal_kernel__msr_read__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
	...
	{
		*count_ptr = glue_unpack(__pos, __msg, __ext, unsigned long long);
	}

	{
		size_t __size = sizeof(unsigned long long);
		*ppos_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, unsigned long long*, (__size), (DEFAULT_GFP_FLAGS));
		if (*ppos_ptr) {
			**ppos_ptr = glue_unpack(__pos, __msg, __ext, unsigned long long);
		}
	...
	*__pos = 0;
	{
		if (*file_ptr) {
			callee_marshal_kernel__msr_read__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
...
void msr_write_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;

	fptr_msr_write function_ptr = glue_unpack(__pos, __msg, __ext, fptr_msr_write);
	struct file* file = 0;
	char* buf = 0;
	unsigned long long count = 0;
	unsigned long long* ppos = 0;
	...
	__maybe_unused struct msr_write_call_ctx call_ctx = {file, buf, count, ppos};
	__maybe_unused struct msr_write_call_ctx *ctx = &call_ctx;
...

	{
		...
		*file_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct file*, (__size), (DEFAULT_GFP_FLAGS));
		if (*file_ptr) {
			callee_unmarshal_kernel__msr_write__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
	...
	*__pos = 0;
	{
		if (*file_ptr) {
			callee_marshal_kernel__msr_write__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
...
void msr_ioctl_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;

	fptr_msr_ioctl function_ptr = glue_unpack(__pos, __msg, __ext, fptr_msr_ioctl);
	struct file* file = 0;
	unsigned int ioc = 0;
	...
	__maybe_unused struct msr_ioctl_call_ctx call_ctx = {file, ioc, arg};
	__maybe_unused struct msr_ioctl_call_ctx *ctx = &call_ctx;
...

	{
		...
		*file_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct file*, (__size), (DEFAULT_GFP_FLAGS));
		if (*file_ptr) {
			callee_unmarshal_kernel__msr_ioctl__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
	...
	{
		*arg_ptr = glue_unpack(__pos, __msg, __ext, unsigned long long);
	}
	...
	*__pos = 0;
	{
		if (*file_ptr) {
			callee_marshal_kernel__msr_ioctl__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
...
void msr_open_callee(struct fipc_message* __msg, struct ext_registers* __ext)
{
	size_t n_pos = 0;
	size_t* __pos = &n_pos;

	fptr_msr_open function_ptr = glue_unpack(__pos, __msg, __ext, fptr_msr_open);
	...
	__maybe_unused struct msr_open_call_ctx call_ctx = {inode, file};
	__maybe_unused struct msr_open_call_ctx *ctx = &call_ctx;
...

	{
		...
		*inode_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct inode*, (__size), (DEFAULT_GFP_FLAGS));
		if (*inode_ptr) {
			callee_unmarshal_kernel__msr_open__inode__in(__pos, __msg, __ext, ctx, *inode_ptr);
		}
...

	{
		...
		*file_ptr = glue_unpack_new_shadow(__pos, __msg, __ext, struct file*, (__size), (DEFAULT_GFP_FLAGS));
		if (*file_ptr) {
			callee_unmarshal_kernel__msr_open__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
	...
	*__pos = 0;
	{
		if (*inode_ptr) {
			callee_marshal_kernel__msr_open__inode__in(__pos, __msg, __ext, ctx, *inode_ptr);
		}
	...
	{
		if (*file_ptr) {
			callee_marshal_kernel__msr_open__file__in(__pos, __msg, __ext, ctx, *file_ptr);
		}
...
int try_dispatch(enum RPC_ID id, struct fipc_message* __msg, struct ext_registers* __ext)
{
	...
	case RPC_ID_llseek:
		glue_user_trace("llseek\n");
		llseek_callee(__msg, __ext);
		break;

	case RPC_ID_msr_read:
		glue_user_trace("msr_read\n");
		msr_read_callee(__msg, __ext);
		break;

	case RPC_ID_msr_write:
		glue_user_trace("msr_write\n");
		msr_write_callee(__msg, __ext);
		break;

	case RPC_ID_msr_ioctl:
		glue_user_trace("msr_ioctl\n");
		msr_ioctl_callee(__msg, __ext);
		break;

	case RPC_ID_msr_open:
		glue_user_trace("msr_open\n");
		msr_open_callee(__msg, __ext);
		break;
