...
static int boot_main(void)
{
	...
	m = lvd_create_module_klcd_no_thread(LCD_DIR("nullnet_gen/net_klcd"),
				"lcd_test_mod_nullnet_gen_net_klcd",
				&net_klcd);
	...
	ret = lvd_create_module_lvd(LCD_DIR("nullnet_gen/dummy_lcd"),
				"lcd_test_mod_nullnet_gen_dummy_lcd",
				&dummy_lcd,
				&dummy_ctx, 1);
	if (ret) {
...
fail4:
	...
	lcd_destroy_module_klcd(net_klcd, "lcd_test_mod_nullnet_gen_net_klcd");
fail3:
