...
static int boot_main(void)
{
	...
	m = lvd_create_module_klcd_no_thread(LCD_DIR("nvme_comb_gen/blk_klcd"),
				"lcd_test_mod_nvme_comb_gen_blk_klcd",
				&blk_klcd);
	...
	ret = lvd_create_module_lvd(LCD_DIR("nvme_comb_gen/nvme_lcd"),
				"lcd_test_mod_nvme_comb_gen_nvme_lcd",
				&nvme_lcd,
				&nvme_ctx, 1);
	if (ret) {
...
fail4:
	...
	lcd_destroy_module_klcd(blk_klcd, "lcd_test_mod_nvme_comb_gen_blk_klcd");
fail3:
