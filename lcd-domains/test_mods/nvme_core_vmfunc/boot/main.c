...
static int boot_main(void)
{
	...
	m = lvd_create_module_klcd_no_thread(LCD_DIR("nvme_core_vmfunc/blk_klcd"),
				"lcd_test_mod_nvme_core_vmfunc_blk_klcd",
				&blk_klcd);
	...
	/* ---------- Create LCD ---------- */
	ret = lvd_create_module_lvd(LCD_DIR("nvme_core_vmfunc/nvme_lcd"),
				"lcd_test_mod_nvme_core_vmfunc_nvme_lcd",
...
fail3:
	...
	lcd_destroy_module_klcd(blk_klcd, "lcd_test_mod_nvme_core_vmfunc_blk_klcd");
fail2:
