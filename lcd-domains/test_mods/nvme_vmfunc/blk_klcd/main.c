...
static int blk_klcd_init(void)
{
	...
	vmfunc_init(lcd_stack, blk_klcd_dispatch_async_loop, blk_klcd_syncipc_dispatch);
 ...
 */
static void __exit blk_klcd_exit(void)
{
	struct fipc_message m;
...
module_init(blk_klcd_init);
module_exit(blk_klcd_exit);
MODULE_LICENSE("GPL");
