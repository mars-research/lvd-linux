...
#ifdef LCD_ISOLATE
static struct notifier_block_container skx_mce_dec_container = {
	.notifier_block = {
#else
...
#ifdef LCD_ISOLATE
	mce_register_decode_chain(&skx_mce_dec_container.skx_mce_dec);
#else
...
skx_exit(void)
{
	edac_dbg(2, "\n");
#ifdef LCD_ISOLATE
	mce_unregister_decode_chain(&skx_mce_dec_container.skx_mce_dec);
#else
