...
ClientCCSTHeaderVisitor::ClientCCSTHeaderVisitor()
{
  
}
CCSTFile* ClientCCSTHeaderVisitor::visit(File *file)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(ProjectionField *proj_field)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(Rpc *rpc)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(Parameter *parameter)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(Typedef *type_def)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(ProjectionType *proj_type)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(PointerType *pointer_type)
{
}
CCSTFile* ClientCCSTHeaderVisitor::visit(IntegerType *integer_type)
{
}

/* ClientCCSTSourceVisitor */

ClientCCSTSourceVisitor::ClientCCSTSourceVisitor()
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(File *file)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(ProjectionField *proj_field)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(Rpc *rpc)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(Parameter *parameter)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(Typedef *type_def)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(ProjectionType *proj_type)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(PointerType *pointer_type)
{
}
CCSTFile* ClientCCSTSourceVisitor::visit(IntegerType *integer_type)
{
}
...
CCSTFile* ServerCCSTHeaderVisitor::visit(ProjectionField *proj_field)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(Rpc *rpc)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(Parameter *parameter)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(Typedef *type_def)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(ProjectionType *proj_type)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(PointerType *pointer_type)
{
}
CCSTFile* ServerCCSTHeaderVisitor::visit(IntegerType *integer_type)
{
}
...
CCSTFile* ServerCCSTSourceVisitor::visit(Rpc *rpc)
{
}
CCSTFile* ServerCCSTSourceVisitor::visit(Parameter *parameter)
{
}
CCSTFile* ServerCCSTSourceVisitor::visit(Typedef *type_def)
{
}
CCSTFile* ServerCCSTSourceVisitor::visit(ProjectionType *proj_type)
{
}
CCSTFile* ServerCCSTSourceVisitor::visit(PointerType *pointer_type)
{
}
CCSTFile* ServerCCSTSourceVisitor::visit(IntegerType *integer_type)
{
}
